...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/assets/vendor/slick/slick.css">
		<link rel="stylesheet" href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/assets/vendor/slick/slick-theme.css">
		<!-- MAIN CSS -->
		...
		<!-- ICONS -->
		<link rel="apple-touch-icon" sizes="76x76" href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/assets/img/apple-icon.png">
		<link rel="icon" type="image/png" sizes="96x96" href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/assets/img/favicon.png">
	</head>
	<body class="layout-topnav">
		...
		<div id="wrapper">
			...
			<nav class="navbar navbar-default navbar-fixed-top">
				...
				<div class="top-bar clearfix">
					<div class="container-bar">
						<div class="brand">
							<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/index.html">
				...
				<div id="navbar-menu" class="bottom-bar clearfix">
					...
					<div class="navbar-collapse collapse" id="main-nav">
						<ul class="nav navbar-nav">
							<li class="dropdown">
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/index.html" class="active" data-toggle="dropdown"><i class="ti-dashboard"></i> <span>Dashboard</span> <i class="ti-angle-down icon-submenu"></i></a>
								<ul class="dropdown-menu">
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/index.html">Dashboard v1</a></li>
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/index2.html">Dashboard v2</a></li>
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/index3.html">Dashboard v3</a></li>
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/index4.html" class="active">Dashboard v4 <span class="label label-success">NEW</span></a></li>
								</ul>
							</li>
							<li class="dropdown">
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" data-toggle="dropdown"><i class="ti-layout"></i> <span>Layouts</span> <i class="ti-angle-down icon-submenu"></i></a>
								<ul class="dropdown-menu">
									<li>
										<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/layout-topnav.html">Top Navigation <span class="label label-success">NEW</span></a>
									</li>
									<li>
										<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/layout-minified.html">Layout Minified</a>
									</li>
									<li>
										<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/layout-fullwidth.html">Layout Fullwidth</a>
									</li>
									<li>
										<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/layout-default.html">Layout Default</a>
									</li>
									<li>
										<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/layout-grid.html">Grid</a>
									</li>
								</ul>
							</li>
							<li class="dropdown">
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" data-toggle="dropdown"><i class="ti-menu"></i> <span>Multilevel Menu</span> <i class="ti-angle-down icon-submenu"></i></a>
								<ul class="dropdown-menu">
									<li class="dropdown dropdown-sub">
										<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" data-toggle="dropdown">Submenu 1 <i class="icon-submenu ti-angle-right"></i></a>
										<ul class="dropdown-menu">
											<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">Another menu level</a></li>
											<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">Another menu level</a></li>
										</ul>
									</li>
									<li class="dropdown dropdown-sub">
										<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" data-toggle="dropdown" class="active">Submenu 2 <i class="icon-submenu ti-angle-right"></i></a>
										<ul class="dropdown-menu">
											<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">Another menu level</a></li>
											<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="active">Another menu level</a></li>
											<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">Another menu level</a></li>
										</ul>
									</li>
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">Submenu 3</a></li>
								</ul>
							</li>
							<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/index.html"><i class="ti-back-left"></i> <span>Back to Default</span></a></li>
						</ul>
						<ul class="nav navbar-nav navbar-right">
							<li class="hidden-xs hidden-sm">
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="btn-toggle-rightsidebar">
									<i class="ti-layout-sidebar-right"></i>
								</a>
							</li>
							<li class="dropdown hidden-xs hidden-sm">
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="dropdown-toggle icon-menu" data-toggle="dropdown">
									<i class="ti-bell"></i>
								...
								<ul class="dropdown-menu notifications">
									...
									<li>
										<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="notification-item">
									...
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="more">See all notifications</a></li>
								</ul>
							</li>
							<li class="dropdown hidden-xs hidden-sm">
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" id="tour-help" class="dropdown-toggle" data-toggle="dropdown"><i class="ti-help"></i> <span class="hide">Help</span></a>
								<ul class="dropdown-menu">
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="ti-direction"></i> Basic Use</a></li>
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="ti-server"></i> Working With Data</a></li>
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="ti-lock"></i> Security</a></li>
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="ti-light-bulb"></i> Troubleshooting</a></li>
								</ul>
							</li>
							<li class="dropdown">
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="dropdown-toggle" data-toggle="dropdown">
									<img src="assets/img/user.png" alt="Avatar">
									<span>Samuel</span> <i class="ti-angle-down icon-submenu"></i></a>
								<ul class="dropdown-menu logged-user-menu">
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="ti-user"></i> <span>My Profile</span></a></li>
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="ti-email"></i> <span>Message</span></a></li>
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="ti-settings"></i> <span>Settings</span></a></li>
									<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="ti-power-off"></i> <span>Logout</span></a></li>
								</ul>
							</li>
						</ul>
					</div>
				...
				<div class="main-content">
					<div class="container">
						<div class="content-heading clearfix">
							...
							<ul class="breadcrumb">
								<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="fa fa-home"></i> Home</a></li>
								<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">Dashboards</a></li>
						...
						<div class="row">
									...
									<div class="col-md-4">
										<div class="widget widget-metric_8">
											<div class="heading clearfix">
												...
												<div class="dropdown">
													<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
													<ul class="dropdown-menu dropdown-menu-right">
														<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="fa fa-refresh"></i> Refresh</a></li>
														<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="fa fa-pencil"></i> Modify</a></li>
													</ul>
												</div>
											</div>
								...
								<div class="panel panel-tab">
									<div class="panel-heading">
										...
										<ul class="nav nav-tabs pull-right">
											<li class="active"><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#tab1" data-toggle="tab"><i class="fa fa-user-circle"></i> Social</a></li>
											<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#tab2" data-toggle="tab"><i class="fa fa-envelope"></i> Newsletter</a></li>
											<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#tab3" data-toggle="tab"><i class="fa fa-pie-chart"></i> Visits</a></li>
										</ul>
									</div>
							...
							<div class="col-md-3">
								...
								<div class="widget widget-metric_5">
									...
									<span class="note">See detailed scoring <a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">here</a></span>
								</div>
							...
							<div class="col-md-4 col-sm-6">
								<div class="widget widget-resume">
									<div class="resume-header">
										<div class="left">
											<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">
												<img src="assets/img/people/male6.png" class="profile-image" alt="">
											</a>
											<div class="bio-text">
												<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="name">Eugene Diaz</a>
											...
											<div class="row">
												...
												<div class="col-xs-10">
													<ul class="list-unstyled list-inline list-tags">
														<li>
															<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="tag tag-green2">UI Design</a>
														</li>
														<li>
															<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="tag tag-orange2">UX</a>
														</li>
													</ul>
												</div>
											</div>
											...
											<ul class="list-unstyled list-widget-vertical no-border spacing-25 margin-bottom-30">
												<li>
													<div class="support-agent">
														<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">
															<img src="assets/img/people/female6.png" class="agent-photo" alt="">
														</a>
														<div class="agent-detail">
															<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="name">Margaret Burns</a>
															<span class="email">margaret@domain.com</span>
															<span class="rating-stars smaller">
																<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i>
																<span class="info">(134 <a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">feedbacks</a>)</span>
															</span>
														</div>
													</div>
												</li>
												<li>
													<div class="support-agent">
														<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">
															<img src="assets/img/people/female3.png" class="agent-photo" alt="">
														</a>
														<div class="agent-detail">
															<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="name">Audrey</a>
															<span class="email">audrey@domain.com</span>
															<span class="rating-stars smaller">
																<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i>
																<span class="info">(122 <a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">feedbacks</a>)</span>
															</span>
														</div>
													</div>
												</li>
												<li>
													<div class="support-agent">
														<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">
															<img src="assets/img/people/male2.png" class="agent-photo" alt="">
														</a>
														<div class="agent-detail">
															<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="name">Walter Harrison</a>
															<span class="email">walter@domain.com</span>
															<span class="rating-stars smaller">
																<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half-o"></i><i class="fa fa-star-o"></i>
																<span class="info">(89 <a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#">feedbacks</a>)</span>
															</span>
														</div>
													</div>
												</li>
											</ul>
											<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="btn btn-primary btn-outline"><i class="fa fa-users"></i> All Agents</a>&nbsp;&nbsp;
											<div class="margin-bottom-15 visible-xs"></div>
											<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="btn btn-default btn-outline"><i class="fa fa-user-plus"></i> Add Agent</a>
										</div>
									</div>
								</div>
				...
				<div id="sidebar-right" class="right-sidebar">
					...
					<div class="sidebar-widget">
						<div class="widget-header">
							...
							<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="show-all">Show all</a>
						</div>
						<div class="row">
							<div class="col-xs-3">
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="icon-app" title="Dropbox" data-toggle="tooltip" data-placement="top">
									<i class="fa fa-dropbox dropbox-color"></i>
								</a>
							</div>
							<div class="col-xs-3">
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="icon-app" title="WordPress" data-toggle="tooltip" data-placement="top">
									<i class="fa fa-wordpress wordpress-color"></i>
								</a>
							</div>
							<div class="col-xs-3">
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="icon-app" title="Drupal" data-toggle="tooltip" data-placement="top">
									<i class="fa fa-drupal drupal-color"></i>
								</a>
							</div>
							<div class="col-xs-3">
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="icon-app" title="Github" data-toggle="tooltip" data-placement="top">
					...
					<div class="sidebar-widget">
						...
						<ul class="list-unstyled list-project-progress">
							<li>
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="project-name">Project XY</a>
							...
							<li>
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="project-name">Growth Campaign</a>
								<div class="progress progress-xs progress-transparent custom-color-blue">
							...
							<li>
								<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="project-name">Website Redesign</a>
								<div class="progress progress-xs progress-transparent custom-color-green">
									<div class="progress-bar" role="progressbar" aria-valuenow="87" aria-valuemin="0" aria-valuemax="100" style="width:87%"></div>
								</div>
					...
					<div class="sidebar-widget">
						...
						<ul class="list-unstyled list-justify list-file-simple">
							<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="fa fa-file-word-o"></i>Proposal_draft.docx</a>
								<span>4 MB</span>
							</li>
							<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="fa fa-file-pdf-o"></i>Manual_Guide.pdf</a>
								<span>20 MB</span>
							</li>
							<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="fa fa-file-zip-o"></i>all-project-files.zip</a>
								<span>315 MB</span>
							</li>
							<li><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#"><i class="fa fa-file-excel-o"></i>budget_estimate.xls</a>
								<span>1 MB</span>
							</li>
						</ul>
					</div>
					<p class="text-center"><a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" class="btn btn-default btn-xs">More Widgets</a></p>
				</div>
				<!-- END RIGHT SIDEBAR -->
			</div>
			<!-- END MAIN -->
			...
			<footer>
				<div class="container-fluid">
					<p class="copyright">&copy; 2017 <a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/https://www.themeineed.com" target="_blank">Theme I Need</a>. All Rights Reserved.</p>
				</div>
			</footer>
		</div>
		<!-- END WRAPPER -->
		...
		<div id="demo-panel">
			<a href="http://demo.thedevelovers.com/dashboard/klorofilpro-v1.6/html/#" onclick="toggleDemoPanel(event);"><i class="fa fa-cog fa-spin"></i></a>
